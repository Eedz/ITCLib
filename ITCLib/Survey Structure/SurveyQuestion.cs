...
namespace ITCLib
{
    ...
    public class SurveyQuestion : ObservableObject
    {
        ...
        public SurveyQuestion DeepCopyWordings()
        {
            ...
            copy.PrePW = new Wording();
            copy.PrePW.WordID = PrePW.WordID;
            copy.PrePW.Type = WordingType.PreP;
            copy.PrePW.WordingText = PrePW.WordingText;
            copy.PreIW = new Wording();
            copy.PreIW.WordID = PreIW.WordID;
            copy.PreIW.Type = WordingType.PreI;
            copy.PreIW.WordingText = PreIW.WordingText;
            copy.PreAW = new Wording();
            copy.PreAW.WordID = PreAW.WordID;
            copy.PreAW.Type = WordingType.PreA;
            copy.PreAW.WordingText = PreAW.WordingText;
            copy.LitQW = new Wording();
            copy.LitQW.WordID = LitQW.WordID;
            copy.LitQW.Type = WordingType.LitQ;
            copy.LitQW.WordingText = LitQW.WordingText;
            copy.PstIW = new Wording();
            copy.PstIW.WordID = PstIW.WordID;
            copy.PstIW.Type = WordingType.PstI;
            copy.PstIW.WordingText = PstIW.WordingText;
            copy.PstPW = new Wording();
            copy.PstPW.WordID = PstPW.WordID;
            copy.PstPW.Type = WordingType.PstP;
            copy.PstPW.WordingText = PstPW.WordingText;
            copy.RespOptionsS = new ResponseSet();
            copy.RespOptionsS.RespSetName = RespOptionsS.RespSetName;
            copy.RespOptionsS.Type = ResponseType.RespOptions;
            copy.RespOptionsS.RespList = RespOptionsS.RespList;
            copy.NRCodesS = new ResponseSet();
            copy.NRCodesS.RespSetName = NRCodesS.RespSetName;
            copy.NRCodesS.Type = ResponseType.NRCodes;
            copy.NRCodesS.RespList = NRCodesS.RespList;
